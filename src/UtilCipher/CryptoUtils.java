...
public class CryptoUtils {
	...
	public String byteToHex(byte b) {
		byte[] bb = { b };
		return DatatypeConverter.printHexBinary(bb);
	}

	public byte hexToByte(String h) {
		byte[] bb = DatatypeConverter.parseHexBinary(h);
		return bb[0];

		// return (byte) (Integer.parseInt(h,16) & 0xff);
	}
	...
	public int byteArrayToInteger(byte[] b) {
